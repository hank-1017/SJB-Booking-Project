    ...
    return function (i) {
        ...
        return n.m = i, n.c = t, n.d = function (i, t, s) {
            ...
            if (n.r(s), Object.defineProperty(s, "default", {
                enumerable: !0,
                value: i
            }), 2 & t && "string" != typeof i) for (var o in i) n.d(s, o, function (t) {
                return i[t]
            }.bind(null, o));
            return s
        }, n.n = function (i) {
        ...
        var a = function () {
            ...
            var t, n, s;
            return t = i, (n = [{
                key: "checkOptionsRequired", value: function (i, t) {
                    var n = "";
                ...
                key: "setOptionsExtend", value: function (i, t) {
                    if (!i) return t;
                    var n;
                    for (n in i) t[n] = i[n];
                    return t
        ...
        function r() {
            return this.options.lang && "en-us" === this.options.lang ? this.data = o : this.data = s, function () {
                var i = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], t = i ? "台" : "臺",
                    n = i ? "臺" : "台";
                ...
                if (function () {
                    ...
                    }.call(this), s = 0, o = this.data.counties.length; s < o; s++) if (!(t && -1 === t.indexOf(this.data.counties[s]) || n && -1 !== n.indexOf(this.data.counties[s]))) {
                ...
                var i = function () {
                    var i = this.elCounty.querySelector("option:checked"), t = i.getAttribute("data-index");
                    c.call(this, t), this.options.hasZipcode && (this.elZipcode.value = "")
                }.bind(this);
                this.elCounty.onchange = i
            }.call(this), function () {
                var i = function () {
                    var i = this.elDistrict.querySelector("option:checked"), t = i.dataset.zipcode || "";
        ...
        function c() {
            ...
            for (var n = function (i) {
                var t = this.options.only, n = "string" == typeof t;
                ...
                var t = this.options.except, n = "string" == typeof t;
                if (!n && !Array.isArray(t)) return null;
                n && (t = [t]);
                var s = null;
                return t.forEach(function (t) {
            ...
            }.call(this, this.elCounty.value), o = 0, e = this.data.districts[i][0].length - 1; o <= e; o++) if (!(n && -1 === n.indexOf(this.data.districts[i][0][o]) || s && -1 !== s.indexOf(this.data.districts[i][0][o]))) {
