<template>
    <main class="about-us">
        ...
        <section class="privacy section" id="privacy-policy">
            <div class="privacy__container grid">
                <div class="privacy__data">
                    <h2 class="section__title privacy_titile">隱私權條款</h2>
                    <p class="privacy__description">
                        非常歡迎您光臨SJB.com，為了讓您能夠安心使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：<br>
